...
public class FlybotAIScript : MonoBehaviour
{
	public float moveSpeed = 3.5f;		// The speed the enemy moves at.
	public int maxHP = 4;				// Enemies max health
    ...
    public AudioClip mDeathClip;		// An array of audioclips that can play when the enemy dies.
